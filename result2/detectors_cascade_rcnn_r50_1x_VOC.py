...
data = dict(
    ...
    val=dict(
        type='VOCDataset',
        ann_file='data/VOCdevkit/VOC2007_val/ImageSets/Main/valtest.txt',
        img_prefix='data/VOCdevkit/VOC2007_val/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        type='VOCDataset',
        ann_file='data/VOCdevkit/VOC2007_val/ImageSets/Main/test.txt',
        img_prefix='data/VOCdevkit/VOC2007_val/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
